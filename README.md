...
I successfully made my first open-source contribution and earned the **"Open Sourcerer" (🪙)** achievement!

### How I Did It

I contributed to [dharmanan's my-first-contribution project](https://github.com/dharmanan/my-first-contribution) by:

1. **Adding my name** to the contributors list
2. **Creating a pull request** (my first ever!)
3. **Getting it merged** by the project maintainer

### My Achievement Badge

![Open Sourcerer Badge](https://github-profile-trophy.vercel.app/?username=YOUR_USERNAME&theme=radical&no-bg=true&no-frame=true&row=1&column=1&margin-w=15&margin-h=15&title=OpenSourcerer)

*Replace `YOUR_USERNAME` in the URL above with your actual GitHub username to display your badge!*

### What I Learned

- How to fork a repository
- How to create and edit files on GitHub
...
A huge thank you to [dharmanan](https://github.com/dharmanan) for creating such a welcoming first contribution project!

---

*This repository was created using the [my-badge-template](https://github.com/dharmanan/my-badge-template) template.*
>>>>>>> 1894be2 (Add detailed step-by-step guides back to Task 1 and Task 2)
